...
<jsp:include page="components/header.jsp" />
        <div class="main">
            <div class="content">
                <h1>Order Form</h1>
                <div class="orderform">
                    <form name="submitform" id="submitform" method="post" action="detail.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-50">
                                ...
                                <h4 style="margin-bottom: 20px;">Basketball ($23.99)</h4>
                                <input type="hidden" id="pid" name="productid" value="1" />
